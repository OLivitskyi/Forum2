...
import { handleRegistrationFormSubmit } from "../handlers/registrationHandlers.js";
    ...
    async getHtml() {
        ...
        <form class="form" id="createAccount">
            <div class="container-login">
                ...
                <p class="form__text">
                    <a class="form__link" href="/" id="linkLogin" data-link>Already have an account? Sign in</a>
                </p>
            </div>
        </form>
        `;
